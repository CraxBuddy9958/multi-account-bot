...
(function() {
    ...
    // Only run on thread pages (URLs like https://crapro.cc/threads/...)
    const THREADS_PATTERN = /https:\/\/craxpro\.cc\/threads\//;
    ...
    function execute() {
        ...
        setTimeout(() => {
            ...
            window.location.href = "https://crapro.cc/forums/proxies-http-https-socks4-socks5/post-thread";
        }, 80000);
    }
