...
async function runAccount(browser, account) {
    ...
    async function injectScriptsForUrl(url) {
        ...
        const isPostThread = url === "https://craxpro.cc/forums/proxies-http-https-socks4-socks5/post-thread" ||
                             url.startsWith("https://craxpro.cc/forums/proxies-http-https-socks4-socks5/post-thread");
